...
@Controller("scanSwitchboardController")
public class SwitchboardController  implements MessageSourceAware{
	...
	@RequestMapping(value="scan/switchboard", method=RequestMethod.GET)
	public String get( Principal principal, Model model,  Locale locale) {
		model.addAttribute("pageTitle", messageSource.getMessage("scan.switchboardTitle", null, locale));
