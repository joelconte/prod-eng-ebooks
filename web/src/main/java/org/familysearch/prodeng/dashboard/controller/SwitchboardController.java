...
@Controller("dashboardSwitchboardController")
public class SwitchboardController  implements MessageSourceAware{
	...
	@RequestMapping(value="dashboard/switchboard", method=RequestMethod.GET)
	public String get( Principal principal, Model model,  Locale locale) {
		model.addAttribute("pageTitle", messageSource.getMessage("dashboard.switchboardTitle", null, locale));
