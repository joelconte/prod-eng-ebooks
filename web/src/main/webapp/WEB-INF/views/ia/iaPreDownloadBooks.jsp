...
function doBooksImport(){
	rc = confirm("Books that you have specified to put into FamilySearch will now be downloaded from Internet Archive and added to TFDB.  Also the xml metadata will be generated.");
	if(rc == false){
		return false;
	}
	var url = "iaDoBooksDownload";//in IaSearchController
    ...
    <div class="span"> 
		...
		<form id="f1" class="" name="f1" method="post" action="${buttonsAction}" >
			...
			<tr>
			   ...
			   <td><button id="release" name="button" value="release"  onclick="doBooksImport(); return false; ">READY - Start Downloads from IA</button></td>
