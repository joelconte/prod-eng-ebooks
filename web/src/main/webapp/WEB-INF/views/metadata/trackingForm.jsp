		...
		<sf:form id="f1" style="margin: 0 0 60px 0;" class="" name="admin-trackingform"  onsubmit="return isvalidform();"  method="post" action="" modelAttribute="book">
			<div class="trackingFormTop1">
			 <table id="tnTable">
				...
				<c:when test="${mode=='read'}">
					...
					<input id="tnPasteSearch" type="text" autocomplete="off" class="" value="${book.tn}" onsubmit="fetchBook2('tnPasteSearch', 'read'); return false;" onchange="fetchBook2('tnPasteSearch', 'read'); return false;"/>
					...
					<button onclick="fetchAllTns('tnSelected', 'read'); return false;">${messages['trackingForm.findAllTn']}</button>
			...
			<table id="table-2cols">
				...
				<td id="col1">
					...
					<td><sf:input id="metadata_complete" path="metadataComplete"  readonly="${isReadOnly}"   />
